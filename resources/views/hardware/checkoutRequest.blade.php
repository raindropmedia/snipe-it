      ...
      <form class="form-horizontal" method="post" action="" autocomplete="off">
        ...
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('name') ? 'error' : '' }}">
              ...
              <div class="col-md-8">
                <p class="form-control-static">{{ $asset->model->name }} {{ old('expected_checkin') }}{{ old('checkout_at') }}</p>
              </div>
            </div>
            @endif
                    ...
                    <div class='col-sm-6'>
                        <div class="form-group" data-provide="datetimepicker" data-date-format="yyyy-mm-dd hh:ii:ss">
                            <div class='input-group date' id='checkout_at'>
                                <input type='text' class="form-control" placeholder="{{ trans('general.select_date') }}" name="checkout_at" value="{{ old('checkout_at', date('d-m-Y H:i')) }}">
                    ...
                    <div class='col-sm-6'>
                        <div class="form-group" data-provide="datetimepicker" data-date-format="yyyy-mm-dd hh:ii:ss">
                            <div class='input-group date' id='expected_checkin'>
                                <input type='text' class="form-control" placeholder="{{ trans('general.select_date') }}" name="expected_checkin" value="{{ old('expected_checkin', date('Y-m-d H:i')) }}">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </span>
                            </div>
                        </div>
            ...
            <div class="form-group {{ $errors->has('note') ? 'error' : '' }}">
              ...
              <div class="col-md-8">
                <textarea class="col-md-6 form-control" id="note" name="note">{{ old('note', $notes) }}</textarea>
