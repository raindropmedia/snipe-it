                        ...
                        <div class="col-md-12">
                                <div class="table-responsive">
                                    <table
                                        ...
                                        data-url="{{ route('api.assets.requestable', array('status' => e(Request::get('status')),'status_id'=>e(Request::get('status_id'))), ['requestable' => true]) }}">
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($requestableModel->isRequestedBy(Auth::user()))
                                                        {{ Form::submit(trans('button.cancel'), ['class' => 'btn btn-danger2 btn-sm'])}}
                                                    @else
